...
InGenR repo structure is based on the wonderful [TypeScript Library Starter](https://github.com/alexjoverm/typescript-library-starter) by [Alex Jover](https://github.com/alexjoverm).

The README of TypeScript Library Starter is retained as a reference for contributors below:
